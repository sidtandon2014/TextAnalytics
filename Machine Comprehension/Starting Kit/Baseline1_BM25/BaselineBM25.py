...
if __name__ == '__main__' :
    folderPath = "F:/Sid\Learnings/Data Scientist/Text Analysis/Machine Comprehension/data/"
    inputFileName = folderPath + "Data.tsv"   # This file should be in the following format : queryid \t query \t passage \t label \t passageid
    testFileName = folderPath + "eval1_unlabelled.tsv"  # This file should be in the following format : queryid \t query \t passage \t passageid # order of the query
    corpusFileName = folderPath + "corpus.tsv" 
    outputFileName = folderPath + "answer.tsv"
