...
if __name__ == "__main__":
    ...
    trainSetFileName = os.path.join(folderPath,"TrainData.ctf")
    validationSetFileName = os.path.join(folderPath,"ValidationData.ctf")
    testSetFileName = os.path.join(folderPath,"EvaluationData.ctf")
    submissionFileName = os.path.join(folderPath,"answer.tsv")
